...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: "Crear una factura" }),
    (0, rol_decorator_1.Roles)('Administador'),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: "Listar una factura por el id" }),
    (0, rol_decorator_1.Roles)('Administador', 'Usuario'),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: "Actualizar una factura segun el id" }),
    (0, rol_decorator_1.Roles)('Administador'),
    __param(0, (0, common_1.Param)('id')),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: "Eliminar una factura segun el id" }),
    (0, rol_decorator_1.Roles)('Administador'),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
